...
import com.acme.learning.platform.learning.interfaces.rest.transform.LearningPathItemResourceFromEntityAssembler;
...
public class CourseLearningPathController {
    ...
    public ResponseEntity<LearningPathItemResource> addTutorialToCourseLearningPath(@PathVariable Long courseId, @PathVariable Long tutorialId) {
        ...
        var getLearningPathItemByCourseIdAndTutorialIdQuery = new GetCourseLearningPathItemByCourseIdAndTutorialIdQuery(courseId, tutorialId);
